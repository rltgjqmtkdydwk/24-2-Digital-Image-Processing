...
image = cv2.imread("/Users/kslivergun/work1/class/24-2-digitalimage/ch05/img/bit_test.jpg", cv2.IMREAD_COLOR)     # 원본 영상 읽기
logo  = cv2.imread("/Users/kslivergun/work1/class/24-2-digitalimage/ch05/img/logo.jpg", cv2.IMREAD_COLOR)         # 로고 영상 읽기
