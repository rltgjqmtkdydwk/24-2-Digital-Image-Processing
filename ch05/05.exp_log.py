...
v2 = np.array([[1], [2], [3]], np.float32)      # 2차원 리스트로(3행, 1열) - 열벡터
v3 = np.array([[1, 2, 3]], np.float32)        	# 2차원 리스트로(1행, 3열) - 행벡터

# OpenCV 산술 연산 함수 - numpy array만 입력 가능함
v1_exp = cv2.exp(v1)                             # 1차원 행렬에 대한 지수
