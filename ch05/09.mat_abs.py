...
image1 = cv2.imread("/Users/kslivergun/work1/class/24-2-digitalimage/ch05/img/abs_test1.jpg", cv2.IMREAD_GRAYSCALE) # 명암도 영상 읽기
image2 = cv2.imread("/Users/kslivergun/work1/class/24-2-digitalimage/ch05/img/abs_test2.jpg", cv2.IMREAD_GRAYSCALE)
...
titles = ['image1', 'image2', 'dif_img1', 'abs_dif1','abs_dif2']    # 윈도우 타이틀 리스트
for title in titles:
