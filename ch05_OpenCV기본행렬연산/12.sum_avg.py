...
image = cv2.imread("/Users/kslivergun/work1/class/24-2-digitalimage/ch05/img/sum_test.jpg", cv2.IMREAD_COLOR)
if image is None: raise Exception("영상 파일 읽기 오류 발생")

mask = np.zeros(image.shape[:2], np.uint8)
mask[60:160, 20:120] = 255                      # 관심영역에 255를 할당
...
# 평균과 표준편차 결과 저장
mean, stddev = cv2.meanStdDev(image)              # 2 원소 튜플로 반환
